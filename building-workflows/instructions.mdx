...
One powerful feature of agent instructions is the ability to include [**context variables**](https://docs.lookfor.ai/guides/context). Context variables are placeholders that the system will fill in with actual customer, shop, or session data at runtime. They let your AI personalize its output, making the conversation (or email) feel more natural and tailored to the individual customer.
...
- The [Context guide](https://docs.lookfor.ai/guides/context) – all dynamic variables by MAS type.
- The [Tools guide](https://docs.lookfor.ai/guides/tools) – every built‑in capability your agents can call.
- The [MASs guide](https://docs.lookfor.ai/guides/multi-agent-systems) – feature comparison of Storefront, Email, Content, and Conversation Insights MAS.
