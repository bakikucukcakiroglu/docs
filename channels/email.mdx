...
Now you should see your email in **Settings/Channels/Email** page. After the successful connection, all your incoming/outgoing emails are stored in lookfor. You can go to **Inbox** page to see your emails. You can send manual responses there, assign an email conversation to a [member](https://docs.lookfor.ai/guides/others/members), or add tags to the email conversation.
...
3. Create agentt accordingly. See [Agents](https://docs.lookfor.ai/guides/agents) guide for more details.
